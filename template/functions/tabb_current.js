   ...
   Ext.create('Ext.panel.Panel', {
    ...
    items: [{
		...
		items:[{
            ...
            xtype: 'textfield',
			readOnly:true,value:'EMP/00000010/2012',
            ...
            xtype: 'datefield',
			readOnly:true,value:'2013-11-28',
...
+'<div id="cngphotodiv"></div>'
    +'<center>'
        +'<a href="#" onClick="'
		+'showPhotoMenu(\'admin_person \',23,\'2396881\',1);">'
